...
import Magnet from "../Animation/Magnet/Magnet.jsx";
  ...
  return (
    <section className="hero">
      ...
      <div className="hero-inner">
        <p className="sub-heading">Hey, i'm Shreyash-Vidhate. I am a</p>
        ...
        <p className="hero-intro">
          Mainly building with ReactJS, I focus on turning ideas into functional
          and visually stunning realities. Lets collaborate and create something
          remarkable together!
        </p>
